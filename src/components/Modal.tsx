  ...
  return (
    <>
      {toggleModal && (
        <>
          <div
            className="modal_background_color h-full w-full absolute 
          ...
          absolute top-0 left-0 text-gray-900">
            <div className="bg-white min-w-[32rem] max-w-4xl max-h-[32rem] z-50 rounded-3xl">
              <div className="px-7 py-3 flex justify-center items-center border-b-2 gap relative ">
                ...
                <div
                  className="bg-slate-600 p-1 w-7 h-7 flex items-center justify-center rounded-full absolute right-3 top-2 cursor-pointer hover:bg-slate-900"
                  onClick={handleClick}>
